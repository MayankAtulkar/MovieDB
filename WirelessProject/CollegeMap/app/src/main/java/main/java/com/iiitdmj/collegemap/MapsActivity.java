...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private Runnable mUpdate = new Runnable() {
        public void run() {
            ...
            sendDataToServer();
            currentX = 23.1783 + currentX;
            currentY = 80.0254 + currentY;
            LatLng latLng = new LatLng(currentX, currentY);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        // Add a marker in IIITDM and move the camera
